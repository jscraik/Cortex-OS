...
```json
{
  "extends": "../../tsconfig.base.json",  // Adjust path to workspace root
  "compilerOptions": {
    "composite": true,      // REQUIRED - enables incremental builds & project references
...
- **Use ONLY when**: Output structure must match specific entry point expectations
  ...
  - Otherwise dist outputs as `dist/src/server.js` (wrong)
