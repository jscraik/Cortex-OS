import type { ExecutionSummary, RunInput } from '../../packages/orchestration/src/langgraph/executor.js';
...
export function bootstrapLanggraphTestHarness(): LanggraphHarness {
        ...
        async function run(input: string | RunInput, options: HarnessRunOptions = {}): Promise<HarnessRunResult> {
                ...
                const summary: ExecutionSummary = result.summary ?? capturedSummary ?? {
