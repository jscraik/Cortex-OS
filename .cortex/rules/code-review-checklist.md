...
- [ ] **Self‑review completed?** The author has read through the change and ensured it does what it intends, run tests, and provided a clear description.
...
- [ ] **Dependencies & abstraction:** Ensure frameworks/libraries are appropriate, avoid unwanted dependencies, and choose the right level of abstraction and modularity.
- [ ] **Correct imports used?** Verify all import statements reference the intended modules, remove unused imports, and choose dependencies that align with project standards and licences.
- [ ] **Reuse existing functionality:** If similar code exists, reuse or extract common functionality.
- [ ] **Design patterns & principles:** Check adherence to SOLID principles and other architectural best practices; avoid premature generalization.
- [ ] **Design artefacts present:** Confirm that up‑to‑date wireframes, wiring diagrams, research documentation and TDD plans accompany this change.
...
- [ ] **Avoid unnecessary complexity:** Ensure functions/classes aren’t overly complex.
...
- [ ] **Test coverage:** Automated tests exist and are updated.
...
This unified checklist now offers industry best practices for release safety, operational excellence, AI/ML governance, security, and human factors, making it suitable for modern, large-scale or AI-driven teams.[2][3][5][1][4]

Sources
[1] Your Ultimate Code Review Checklist: 8 Pillars for 2025 <https://getnerdify.com/blog/code-review-checklist/>
[2] Empirically sup code review best practices <https://graphite.dev/blog/code-review-best-practices>
[3] AI security checklist (updated 2025) <https://lumenalta.com/insights/ai-security-checklist-updated-2025>
[4] Rollback Plan Checklist: Safeguard Your Software Releases! <https://www.manifest.ly/use-cases/software-development/rollback-plan-checklist>
[5] Source Code Audit Checklist: Best Practices for Secure Code <https://www.codeant.ai/blogs/source-code-audit-checklist-best-practices-for-secure-code>
[6] Top 7 Code Review Best Practices For Developers in 2025 <https://www.qodo.ai/blog/code-review-best-practices/>
[7] Code Review Checklist <https://www.codereviewchecklist.com>
[8] Peer Code Review Checklist: 10 Best Practices for Dev Teams <https://jellyfish.co/library/developer-productivity/peer-code-review-best-practices/>
[9] The Ultimate Code Review Checklist For Developers <https://blog.codacy.com/code-review-checklist>
[10] How to Present Rollback Drills & Readiness <https://www.resumly.ai/blog/how-to-present-rollback-drills-and-readiness>
[11] The code review checklist that actually helps <https://appfire.com/resources/blog/code-review-checklist>
[12] OWASP's LLM AI Security & Governance Checklist <https://www.reversinglabs.com/blog/owasp-llm-ai-security-governance-checklist-13-action-items-for-your-team>
[13] OPS07-BP02 Ensure a consistent review of operational ... <https://docs.aws.amazon.com/wellarchitected/latest/framework/ops_ready_to_support_const_orr.html>
[14] Code Review Checklist for JavaScript/React <https://community.ibm.com/community/user/blogs/marina-mascarenhas/2025/07/15/code-review-checklist-for-javascriptreact>
[15] AI Security Checklist - Protect Systems from Threats in 2025 <https://www.practical-devsecops.com/ai-security-checklist/>
[16] What is Rollback Plan? | Definition & Overview <https://www.prodpad.com/glossary/rollback-plan/>
[17] The Standard of Code Review | eng-practices - Google <https://google.github.io/eng-practices/review/reviewer/standard.html>
[18] Code Review Security Checklist for Secure Development <https://amplify.security/blog/code-review-security-checklist>
[19] How Atlassian does operational readiness <https://www.atlassian.com/devops/what-is-devops/operational-readiness>
[20] Top 6 Code Review Best Practices To Implement in 2025 <https://zencoder.ai/blog/code-review-best-practices>
