...
export function isDocsSemsearchEnabled(env: Record<string, string | undefined> = process.env): boolean {
...
export function getDocsSemsearchConfig(env: Record<string, string | undefined> = process.env): DocsIngestConfig {
