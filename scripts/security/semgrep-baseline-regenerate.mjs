...
async function main() {
	...
	const confirm = await prompt(
		'This will overwrite reports/semgrep-baseline.json. Continue? (yes/no): ',
	);
	...
	if (semgrepFailed) {
		console.warn(
			'[baseline] Proceeding with generated file despite Semgrep error (verify contents).',
		);
	}
	...
	const commitMsg =
		issueRef && issueRef.toUpperCase() !== 'NONE'
