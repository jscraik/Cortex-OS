...
let eventsContent = fs.existsSync(eventsFile) ? fs.readFileSync(eventsFile, 'utf8') : `// ${domain} event contracts\n// Auto-generated scaffold; extend intentionally.\nimport { z } from 'zod';\n\n`;

const schemaConstName = eventName.replace(/\./g, '_') + 'Schema';
if (eventsContent.includes(`const ${schemaConstName}`) || eventsContent.includes(`export const ${schemaConstName}`)) {
