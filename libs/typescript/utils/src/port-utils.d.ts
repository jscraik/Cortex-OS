 ...
 */
export declare function findAvailablePort(startPort?: number, maxAttempts?: number, host?: string): Promise<number>;
/**
 * Get an available port or use default if available
 */
export declare function getPort(preferredPort?: number, host?: string): Promise<number>;
/**
 ...
 */
export declare function getPortInRange(range: {
    start: number;
    end: number;
}, host?: string): Promise<number>;
/**
 * Port allocation for tests to prevent conflicts
 */
export declare class TestPortAllocator {
    private static readonly allocatedPorts;
    /**
     * Allocate a port for testing, ensuring no conflicts
     */
    static allocate(preferredPort?: number): Promise<number>;
    /**
