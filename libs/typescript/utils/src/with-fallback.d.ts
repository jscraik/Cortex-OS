 ...
 */
export declare function withFallback<T>(providers: FallbackProvider<T>[], options?: FallbackOptions): Promise<T>;
/**
 * Creates a fallback provider from a function
 */
export declare function createProvider<T>(name: string, execute: () => Promise<T>): FallbackProvider<T>;
