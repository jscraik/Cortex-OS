export const validateNeo4jInput = {
    ...
    label(label) {
        ...
        if (!/^[a-zA-Z]\w*$/.test(label)) {
            return { success: false, error: 'Label must start with a letter and contain only alphanumeric characters and underscores' };
        }
    ...
    type(type) {
        ...
        if (!/^[A-Z][A-Z0-9_]*$/.test(type)) {
            return { success: false, error: 'Relationship type must start with an uppercase letter and contain only uppercase alphanumeric characters and underscores' };
        }
    ...
    propertyKey(key) {
        ...
        if (!/^[a-zA-Z][\w.]*$/.test(key)) {
            return { success: false, error: 'Property key must start with a letter and contain only alphanumeric characters, underscores, and dots' };
        }
