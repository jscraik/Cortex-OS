...
export const SimulateClickInputSchema = z.object({
  ...
  meta: z
    ...
    .default({ altKey: false, ctrlKey: false, shiftKey: false, metaKey: false }),
});
...
// render_tree: render hierarchical tree structure (e.g., context map)
...
// Tool registry style export (mirrors observability pattern)
...
export const webuiMcpTools: WebuiMcpTool[] = [
  { name: 'open_panel', description: 'Open or focus a UI panel', inputSchema: OpenPanelInputSchema },
  { name: 'update_component_state', description: 'Patch component state via path', inputSchema: UpdateComponentStateInputSchema },
  { name: 'navigate', description: 'Navigate internal application route', inputSchema: NavigateInputSchema },
  { name: 'simulate_click', description: 'Simulate a click user interaction', inputSchema: SimulateClickInputSchema },
  { name: 'submit_form', description: 'Submit or validate a form with field values', inputSchema: SubmitFormInputSchema },
  { name: 'send_chat_message', description: 'Send a chat message in the active session', inputSchema: SendChatMessageInputSchema },
  { name: 'render_chart', description: 'Render a lightweight chart from provided series', inputSchema: RenderChartInputSchema },
  { name: 'generate_timeline', description: 'Generate a timeline visualization of events', inputSchema: GenerateTimelineInputSchema },
  { name: 'render_tree', description: 'Render a hierarchical tree structure', inputSchema: RenderTreeInputSchema },
];
