...
export declare const A2AEventStreamSubscribeInputSchema: z.ZodObject<{
    events: z.ZodOptional<z.ZodDefault<z.ZodArray<z.ZodEnum<["taskCompleted", "taskFailed", "taskCancelled", "taskRunning"]>, "many">>>;
    since: z.ZodOptional<z.ZodString>;
    includeCurrent: z.ZodOptional<z.ZodDefault<z.ZodBoolean>>;
}, "strip", z.ZodTypeAny, {
    events?: ("taskCompleted" | "taskFailed" | "taskCancelled" | "taskRunning")[] | undefined;
...
export declare const A2AEventStreamEventSchema: z.ZodObject<{
    type: z.ZodEnum<["taskCompleted", "taskFailed", "taskCancelled", "taskRunning"]>;
    id: z.ZodString;
    status: z.ZodEnum<["pending", "running", "completed", "failed", "cancelled"]>;
...
export declare const A2AOutboxSyncInputSchema: z.ZodObject<{
    action: z.ZodEnum<["processPending", "processRetries", "cleanup", "dlqStats"]>;
...
export declare const A2AMcpToolNames: readonly ["a2a_event_stream_subscribe", "a2a_queue_message", "a2a_outbox_sync"];
