...
export declare const AgentToolkitSearchResultSchema: z.ZodObject<{
    ...
    tool: z.ZodUnion<[z.ZodUnion<[z.ZodLiteral<"ripgrep">, z.ZodLiteral<"semgrep">]>, z.ZodLiteral<"ast-grep">]>;
...
export declare const AgentToolkitValidationResultSchema: z.ZodObject<{
    ...
    tool: z.ZodUnion<[z.ZodUnion<[z.ZodUnion<[z.ZodLiteral<"eslint">, z.ZodLiteral<"ruff">]>, z.ZodLiteral<"cargo">]>, z.ZodLiteral<"pytest">]>;
...
export declare const AgentToolkitInputSchema: z.ZodUnion<[z.ZodObject<{
    pattern: z.ZodString;
    path: z.ZodString;
}, "strip", z.ZodTypeAny, {
    path: string;
...
export declare const AgentToolkitResultSchema: z.ZodUnion<[z.ZodObject<{
    timestamp: z.ZodOptional<z.ZodString>;
} & {
    tool: z.ZodUnion<[z.ZodUnion<[z.ZodLiteral<"ripgrep">, z.ZodLiteral<"semgrep">]>, z.ZodLiteral<"ast-grep">]>;
    op: z.ZodLiteral<"search">;
...
export type AgentToolkitExecutionStartedEvent = z.infer<typeof AgentToolkitExecutionStartedEventSchema>;
export type AgentToolkitExecutionCompletedEvent = z.infer<typeof AgentToolkitExecutionCompletedEventSchema>;
export type AgentToolkitExecutionFailedEvent = z.infer<typeof AgentToolkitExecutionFailedEventSchema>;
