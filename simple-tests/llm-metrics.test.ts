...
const dataset = [
  { prompt: 'Is the sky blue?', expected: 'yes', response: 'yes', latency_ms: 120 },
  { prompt: 'Are cats mammals?', expected: 'yes', response: 'yes', latency_ms: 150 },
  { prompt: 'Is 2+2=5?', expected: 'no', response: 'no', latency_ms: 110 },
  { prompt: 'Is Earth flat?', expected: 'no', response: 'yes', latency_ms: 200 },
];
