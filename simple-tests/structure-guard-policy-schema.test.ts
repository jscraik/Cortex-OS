...
import {
    validatePolicy,
    type StructureGuardPolicy
} from './policy-schema-impl.js';
...
describe('Structure Guard Policy Schema', () => {
  ...
  describe('Policy Versioning', () => {
    ...
    it('should warn about deprecated fields in older versions', () => {
      ...
      const result = validatePolicy(v1PolicyWithDeprecated, { allowDeprecated: true });
  ...
  describe('Security Validation', () => {
    ...
    it('should require denied patterns for sensitive file types', () => {
      ...
      const result = validatePolicy(policyMissingSecurityDenies, { strict: true });
  ...
  describe('Performance Validation', () => {
    it('should warn about performance-impacting configurations', () => {
      ...
      const result = validatePolicy(performanceHeavyPolicy, { checkPerformance: true });
