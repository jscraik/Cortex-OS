...
function buildHierQueryResponse(
  ...
  flags: { multimodal: boolean; selfRag: boolean; metrics?: { rounds: number; retrievalCalls: number; critiques: string[] } },
) {
...
function buildIngestPayload(payload: ReturnType<typeof RagIngestRequestSchema.parse>): IngestRequest {
  return {
