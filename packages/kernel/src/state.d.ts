		...
		governance: z.ZodObject<
			{
				...
				codeownersMapping: z.ZodDefault<
...
export declare const PRPStateSchema: z.ZodObject<
	{
		...
		runId: z.ZodString;
		phase: z.ZodEnum<
			['strategy', 'build', 'evaluation', 'completed', 'recycled']
		>;
		...
		>;
		enforcementProfile: z.ZodOptional<
			z.ZodObject<
				{
					budgets: z.ZodObject<
						{
					...
					architecture: z.ZodObject<
						{
							allowedPackageBoundaries: z.ZodDefault<
								z.ZodArray<z.ZodString, 'many'>
							>;
							namingConventions: z.ZodDefault<
								z.ZodRecord<z.ZodString, z.ZodString>
							>;
							repoLayout: z.ZodDefault<z.ZodArray<z.ZodString, 'many'>>;
							crossBoundaryImports: z.ZodDefault<
								z.ZodArray<z.ZodString, 'many'>
							>;
						},
						'strip',
					...
					governance: z.ZodObject<
						{
							...
							codeownersMapping: z.ZodDefault<
								z.ZodRecord<z.ZodString, z.ZodArray<z.ZodString, 'many'>>
							>;
							structureGuardExceptions: z.ZodDefault<
								z.ZodArray<z.ZodString, 'many'>
							>;
							requiredChecks: z.ZodDefault<z.ZodArray<z.ZodString, 'many'>>;
						},
		...
		metadata: z.ZodObject<
			{
				...
				validationAdjustments: z.ZodOptional<
					z.ZodRecord<z.ZodString, z.ZodUnknown>
				>;
				gateModifications: z.ZodOptional<
					z.ZodRecord<z.ZodString, z.ZodUnknown>
				>;
				workflowAlterations: z.ZodOptional<
					z.ZodRecord<z.ZodString, z.ZodUnknown>
				>;
 ...
 */
export declare const validateStateTransition: (
	fromState: PRPState,
	toState: PRPState,
) => boolean;
/**
 ...
 */
export declare const createInitialPRPState: (
