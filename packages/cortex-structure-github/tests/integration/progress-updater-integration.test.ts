...
describe('Progress Updater Integration Tests', () => {
  ...
  describe('Memory Management', () => {
    ...
    it('cleans up stale progress tasks automatically', async () => {
      ...
      // Create a task
      const taskId = await progressUpdater.startProgress(
        mockPayload,
        'test-task',
        'user',
        [{ title: 'Test task' }]
    ...
    it('destroys resources properly', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('LiveProgressUpdater destroyed and resources cleaned up');
