 ...
 */
export declare function generatePRPMarkdown(state: PRPState, document: PRPDocument, reviewJson?: ReviewJSON): string;
/**
 * Write prp.md file to filesystem
 */
export declare function writePRPDocument(prpContent: string, outputPath: string): Promise<void>;
/**
