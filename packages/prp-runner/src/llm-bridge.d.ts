...
export declare function listMLXModels(state: LLMState): Promise<import("./mlx-adapter.js").MLXModelInfo[]>;
export declare function checkProviderHealth(state: LLMState): Promise<{
    healthy: boolean;
    message: string;
}>;
export declare function generate(state: LLMState, prompt: string, options?: LLMGenerateOptions): Promise<string>;
