...
class QualityBudgetsSatisfiedCheck {
    ...
    async execute(context) {
        ...
        const ok = b.coverageLines > 0 && b.coverageBranches > 0 && b.performanceLCP > 0 && b.performanceTBT > 0 && b.a11yScore > 0;
        const evidence = [{
                id: nanoid(),
                type: "validation",
...
export class G4VerificationGate extends BaseGate {
    id = "G4";
    name = "Verification";
    purpose = "Verify that implemented solution meets the planned quality budgets (stubbed)";
