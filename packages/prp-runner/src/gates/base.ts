...
// For now, we'll define types locally until kernel package exports are updated
...
export interface Evidence {
	id: string;
	type: "file" | "command" | "test" | "analysis" | "validation" | "llm-generation" | "coverage" | "a11y" | "security" | "sbom";
	source: string;
	content: string;
	timestamp: string;
