...
from integrations.memory_bridge import (
    QdrantVectorStore as BridgeQdrantVectorStore,  # type: ignore
)
...
class MemoryBridgeVectorAdapter:
    ...
    async def add_document(
        ...
        *,
        ...
        await self._vs.store_embedding(
            memory_id=doc_id or "", embedding=embedding, metadata=payload
        )
