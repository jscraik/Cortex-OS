...
import type { FlushPacket, StreamMultiplexer, WSOptions, WebSocketLike } from './types.js';
...
const removeListener = (socket: WebSocketLike, event: 'close' | 'error', handler: () => void): void => {
