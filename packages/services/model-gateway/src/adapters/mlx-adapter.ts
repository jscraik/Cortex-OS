...
export interface MLXAdapterApi {
        ...
        generateEmbedding(request: { text: string; model?: string }): Promise<{ embedding: number[]; model: string }>;
        generateEmbeddings(request: { texts: string[]; model?: string }): Promise<{ embedding: number[]; model: string }[]>;
