...
function createErrorResponse(tool: string, correlationId: string, error: NormalizedError): RAGToolResponse {
...
export const ragIngestToolSchema = z.object({
        ...
        source: z
                .string()
                .optional()
                .describe('Source identifier for the content'),
        metadata: z
                .record(z.unknown())
                .optional()
...
export const ragQueryTool: RAGTool = {
        ...
        handler: async (params: unknown) => {
                ...
                try {
                        const { query: rawQuery, topK, maxTokens, timeoutMs } =
