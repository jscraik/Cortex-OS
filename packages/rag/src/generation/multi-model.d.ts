...
export declare class MultiModelGenerator implements Generator {
     ...
     */
    generate(prompt: string, config?: Partial<GenerationConfig>): Promise<{
        content: string;
        provider: "mlx" | "ollama";
        usage: {
            promptTokens: number;
     ...
     */
    chat(messages: ChatMessage[], config?: Partial<GenerationConfig>): Promise<{
        content: string;
        provider: "mlx" | "ollama";
        usage: {
            promptTokens: number;
 ...
 */
export declare function createMultiModelGenerator(options: MultiModelGeneratorOptions): MultiModelGenerator;
/**
