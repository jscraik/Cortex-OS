...
export class ArchonEmbedder implements Embedder {
    ...
    async embed(texts: string[]): Promise<number[][]> {
        try {
            ...
            interface EmbeddingsToolResult { embeddings?: number[][] }
...
export function createArchonEnhancedStore(localStore: StoreLike, config: ArchonRAGConfig): ArchonEnhancedStore {
