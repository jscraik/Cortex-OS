...
import { __resetPolicyRateLimiter, enforce, Grant } from '../src';

describe('policy engine', () => {
  beforeEach(() => {
    // reset naive in-memory rate limiter between tests to avoid cross-test pollution
    __resetPolicyRateLimiter();
  });
