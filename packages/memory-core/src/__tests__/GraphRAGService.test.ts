...
import { createGraphRAGService, GraphRAGQueryRequestSchema, GraphRAGService } from '../services/GraphRAGService.js';
...
vi.mock('../retrieval/QdrantHybrid.js', async () => {
  const actual = await vi.importActual<typeof import('../retrieval/QdrantHybrid.js')>('../retrieval/QdrantHybrid.js');
  return {
    ...actual,
