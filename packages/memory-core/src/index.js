export { CheckpointManager, createCheckpointManager, ensureCheckpointSchema, resolveCheckpointPolicy, } from './checkpoints/index.js';
...
export { createGraphRAGIngestService, GraphRAGIngestService, } from './services/GraphRAGIngestService.js';
export { createGraphRAGService, GraphRAGService, } from './services/GraphRAGService.js';
...
export function createMemoryProviderFromEnv() {
    ...
    if (process.env.QDRANT_URL) {
        config.qdrant = {
            ...
            embedDim: parseInt(process.env.EMBED_DIM || '384', 10),
            similarity: process.env.SIMILARITY || 'Cosine',
