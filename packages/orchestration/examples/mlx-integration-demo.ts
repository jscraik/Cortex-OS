...
function processUser(user: any) {
  ...
  const candidateAgents = [
    { id: 'db-expert', capabilities: ['database', 'optimization', 'sql'], currentLoad: 0.6 },
    { id: 'backend-dev', capabilities: ['backend', 'api', 'database'], currentLoad: 0.3 },
    { id: 'full-stack', capabilities: ['frontend', 'backend', 'database'], currentLoad: 0.8 },
    { id: 'performance-specialist', capabilities: ['performance', 'profiling'], currentLoad: 0.4 },
  ];
