...
async function validateDashboardToolLayer() {
    try {
        ...
        if (vizResult.type === 'visualization' &&
            ...
            console.log(`   - Generated ${vizResult.data.nodes.length} nodes and ${vizResult.data.edges.length} edges`);
        } else {
        ...
        if (dashboardResult.type === 'dashboard' &&
        ...
        if (healthResult.type === 'dashboard' &&
            ...
            console.log(`   - Generated health dashboard with ${healthResult.components.length} components`);
        } else {
        ...
        if (timelineResult.type === 'visualization' &&
...
// Run validation
validateDashboardToolLayer().then(success => {
