...
describe('orchestration MCP tool contracts', () => {
        ...
        const updateTaskStatusTool = taskManagementTools.find((tool) => tool.name === 'task.update_status');
        const getProcessStatusTool = processMonitoringTools.find((tool) => tool.name === 'process.get_status');
