...
describe('cross-package n0 state alignment', () => {
        ...
        it('keeps state keys aligned across agents, kernel, and orchestration', () => {
                ...
                expect(sortedKeys(agentN0)).toEqual(['budget', 'ctx', 'input', 'messages', 'output', 'session']);
                expect(sortedKeys(kernelN0)).toEqual(['budget', 'ctx', 'input', 'messages', 'output', 'session']);
                expect(sortedKeys(cortexN0)).toEqual(['budget', 'ctx', 'input', 'messages', 'output', 'session']);
