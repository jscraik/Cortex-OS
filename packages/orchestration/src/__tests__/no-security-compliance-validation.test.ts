...
import { validateExecutionRequest, validateToolCapability } from '../contracts/no-architecture-contracts.js';
...
describe('nO Security and Compliance Validation', () => {
    ...
    describe('Input Validation and Sanitization', () => {
        ...
        it('should enforce resource bounds to prevent DoS attacks', async () => {
            ...
            await expect(scheduler.planExecution(dosRequest))
                .rejects
                .toThrow('Number must be less than or equal to');
        });
    });
