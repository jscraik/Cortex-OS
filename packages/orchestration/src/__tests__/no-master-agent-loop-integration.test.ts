...
import { AgentPoolManager, type AgentPoolConfiguration } from '../master-agent-loop/agent-pool-manager.js';
...
describe('nO Master Agent Loop Integration', () => {
    ...
    describe('Core Component Integration', () => {
        it('should create and execute basic nO workflow', async () => {
            ...
            expect(executionPlan.strategy).toBeOneOf(['sequential', 'parallel', 'hierarchical', 'adaptive']);
    ...
    describe('Performance and Scalability', () => {
        it('should handle multiple concurrent planning requests', async () => {
            ...
            const plans = await Promise.all(
                requests.map(req => scheduler.planExecution(req))
            );
