...
export class ConfigurationManager extends EventEmitter {
	...
	private static readonly OperationalConfigurationSchema = z.object({
		...
		security: z.object({
			...
			rbac: z.object({
				...
				roleHierarchy: z.record(z.array(z.string())),
			}),
	...
	private mergeConfigurations(
		...
		try {
			return ConfigurationManager.OperationalConfigurationSchema.parse(
				mergedRecord,
			) as OperationalConfiguration;
		} catch (e) {
