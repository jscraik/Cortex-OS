 ...
 */
export function createNoTelemetryEvent(source, eventType, operation, context, payload, metadata) {
 ...
 */
export function createNoAuditEntry(operation, actor, resource, action, compliance, metadata) {
