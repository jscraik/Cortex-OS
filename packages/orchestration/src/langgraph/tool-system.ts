import { bindKernelTools, type BindKernelToolsOptions, type KernelToolBinding } from '@cortex-os/kernel';
...
export function createHookAwareDispatcher(options: HookAwareDispatcherOptions): HookAwareDispatcher {
