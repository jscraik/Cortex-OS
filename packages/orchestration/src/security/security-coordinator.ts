...
import { OrchestrationStrategy, type PlanningComplianceState, type PlanningComplianceViolation, type PlanningContext } from '../types.js';
                ...
                await Promise.all(
                        violations.map((violation) =>
                                this.publisher.publishComplianceViolation({
                                        ...
                                        advisory:
                                                violation.advisory ??
                                                'brAInwav compliance coordinator dispatched mitigation guidance.',
                                }),
                        ),
                );
