...
export class StrategySelector {
    ...
    private evaluateComplianceInfluence(
        ...
        const highestSeverity = violationCount
            ? compliance.outstandingViolations.reduce<'low' | 'medium' | 'high' | 'critical'>((acc, violation) =>
    ...
    private getCompliancePenalty(
        ...
        if (strategy === OrchestrationStrategy.PARALLEL || strategy === OrchestrationStrategy.ADAPTIVE) {
