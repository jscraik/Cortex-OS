...
export class LifecycleMemoryStore implements MemoryStore {
  ...
  async upsert(memory: Memory, namespace = 'default', context?: any): Promise<Memory> {
  ...
  async get(id: string, namespace = 'default', context?: any): Promise<Memory | null> {
  ...
  async delete(id: string, namespace = 'default', context?: any): Promise<void> {
  ...
  async searchByText(q: TextQuery, namespace = 'default', context?: any): Promise<Memory[]> {
  ...
  async searchByVector(q: VectorQuery, namespace = 'default', context?: any): Promise<(Memory & { score: number })[]> {
  ...
  async purgeExpired(nowISO: string, namespace?: string, context?: any): Promise<number> {
    return this.store.purgeExpired(nowISO, namespace);
  }

  async list(namespace = 'default', limit?: number, offset?: number, context?: any): Promise<Memory[]> {
  ...
  private findMemoriesForRetention(policy: RetentionPolicy, namespace: string, now: number): Promise<Memory[]> {
  ...
  private async createConsolidatedMemory(memories: Memory[], strategy: CompactionStrategy): Promise<Memory> {
  ...
  private trackUpsert(memory: Memory, namespace: string): void {
  ...
  private trackDelete(id: string, namespace: string): void {
