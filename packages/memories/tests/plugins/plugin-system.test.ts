...
import { MemoryPlugin, StoreContext, QueryContext } from '../../src/plugins/types.js';
import { createMemory, TestMemoryStore } from '../test-utils.js';
import type { Memory, TextQuery, VectorQuery } from '../../src/domain/types.js';
...
describe('Plugin System', () => {
  ...
  describe('Plugin Registration', () => {
    ...
    it('should throw error when registering plugin with duplicate name', () => {
      ...
      // Then
      expect(() => pluginStore.register(plugin2)).toThrow('Plugin with name "duplicate" already registered');
    });
  });
