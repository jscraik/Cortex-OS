...
import type { RequestOptions, ApiResponse, AuthMethod } from '../../../src/adapters/rest-api/types.js';
...
describe('HTTP Client', () => {
  ...
  describe('Headers', () => {
    it('should set default headers', () => {
      ...
      // Then
      expect((client as any).defaultHeaders).toEqual(expect.objectContaining({
        'X-Custom-Header': 'custom-value',
        'X-Another-Header': 'another-value',
      }));
    });
