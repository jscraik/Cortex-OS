  ...
  describe('Convenience Methods', () => {
    it('should provide typed convenience methods', async () => {
      ...
      await largeBatchPublisher.publishMemoryCreated('id1', 'ns', {
        memory: { id: 'id1', kind: 'note', text: 'test', createdAt: '', updatedAt: '', provenance: { source: 'system' } },
      });

      await largeBatchPublisher.publishMemoryUpdated('id2', 'ns', {
        memory: { id: 'id2', kind: 'note', text: 'updated', createdAt: '', updatedAt: '', provenance: { source: 'system' } },
        changes: {
          old: { text: 'old' },
          new: { text: 'updated' },
        },
