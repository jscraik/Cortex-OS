...
import { createBus, type BusOptions, type Transport } from '@cortex-os/a2a-core/bus';
...
const DEFAULT_TOPIC_ACL: TopicACL = Object.freeze(
        Object.fromEntries(
                Object.values(OBSERVABILITY_EVENT_TYPES).map((type) => [type, { publish: true, subscribe: true }]),
        ),
) as TopicACL;
