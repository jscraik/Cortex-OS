...
vi.mock("@opentelemetry/resources", () => ({ Resource: class Resource { constructor(public attrs: any) {} } }));
vi.mock("@opentelemetry/semantic-conventions", () => ({ ATTR_SERVICE_NAME: "service.name", ATTR_SERVICE_VERSION: "service.version" }));
vi.mock("@opentelemetry/exporter-trace-otlp-http", () => ({ OTLPTraceExporter: class OTLPTraceExporter {} }));
vi.mock("@opentelemetry/exporter-jaeger", () => ({ JaegerExporter: class JaegerExporter {} }));
vi.mock("@opentelemetry/sdk-trace-base", () => ({ ConsoleSpanExporter: class ConsoleSpanExporter {} }));
vi.mock("@opentelemetry/sdk-metrics", () => ({
  ConsoleMetricExporter: class ConsoleMetricExporter {},
  PeriodicExportingMetricReader: class PeriodicExportingMetricReader {
    exporter: any;
    constructor(opts: any) { this.exporter = opts.exporter; }
  },
}));
vi.mock("@opentelemetry/exporter-metrics-otlp-http", () => ({ OTLPMetricExporter: class OTLPMetricExporter {} }));
