...
export declare const EvaluateAlertInputSchema: z.ZodObject<{
    alertId: z.ZodString;
    metricWindow: z.ZodOptional<z.ZodObject<{
...
export declare class ObservabilityToolError extends Error {
    ...
    constructor(code: 'validation_error' | 'security_error' | 'internal_error', message: string, details?: string[]);
}
export declare function validateObservabilityToolInput(tool: ObservabilityTool['name'], input: unknown, options?: {
...
export declare function createObservabilityErrorResponse(tool: ObservabilityTool['name'], error: ObservabilityToolError, correlationId?: string): {
    isError: boolean;
    metadata: {
        tool: string;
