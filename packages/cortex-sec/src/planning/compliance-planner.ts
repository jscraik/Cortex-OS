...
function deriveActions(riskScore: number, signals: Array<ComplianceSignal & { policy: SecurityPolicy }>): SecurityActionPlan[] {
        ...
        if (riskScore >= 0.7) {
                actions.push({
                        ...
                        description: 'Run immediate Semgrep and compliance validation scans using cortex-sec MCP tools.',
