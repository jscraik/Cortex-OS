...
import type { RegisteredSchema, SchemaEvolutionResult, SchemaRegistryConfig, SchemaRegistryStats, SchemaSearchOptions, ValidationResult } from '../../a2a-contracts/src/schema-registry-types.js';
/**
