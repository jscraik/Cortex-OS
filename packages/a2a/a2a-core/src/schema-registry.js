...
export class SchemaRegistry {
    ...
    checkCompatibility(eventType, newSchema) {
        ...
        try {
            ...
            if (!newResult.success) {
                ...
                recommendations.push('Consider making the new schema more permissive or providing migration guidance');
            }
        }
        catch (error) {
    ...
    getStats() {
        const cacheHitRate = this.stats.cacheHits + this.stats.cacheMisses > 0
            ...
            : 0;
        const avgValidationTime = this.stats.validationCount > 0
