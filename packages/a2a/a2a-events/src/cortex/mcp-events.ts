...
export const createMcpEvent = {
  toolExecution: (data: Omit<McpToolExecutionEvent, 'event_id' | 'event_type' | 'source' | 'timestamp'>) => ({
  ...
  toolResponse: (data: Omit<McpToolResponseEvent, 'event_id' | 'event_type' | 'source' | 'timestamp'>) => ({
    event_id: crypto.randomUUID(),
  ...
  contextCreated: (data: Omit<McpContextCreatedEvent, 'event_id' | 'event_type' | 'source' | 'timestamp'>) => ({
    event_id: crypto.randomUUID(),
