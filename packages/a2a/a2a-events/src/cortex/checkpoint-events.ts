import { BranchIdSchema, CheckpointIdSchema, CheckpointMetaSchema } from '@cortex-os/contracts';
import { z } from 'zod';
...
export type CheckpointBranchStartedEvent = z.infer<typeof CheckpointBranchStartedEventSchema>;
...
export type CheckpointBranchCompletedEvent = z.infer<typeof CheckpointBranchCompletedEventSchema>;
...
export function validateCheckpointRolledBackEvent(data: unknown): CheckpointRolledBackEvent {
...
export function validateCheckpointBranchStartedEvent(data: unknown): CheckpointBranchStartedEvent {
