import type { OutboxRepository } from '../a2a-contracts/src/outbox-types.js';
import { OutboxMessageStatus } from '../a2a-contracts/src/outbox-types.js';
...
export async function replayPending(
	...
	let processed = 0;
	const pending = await ctx.repository.findByStatus(
		OutboxMessageStatus.PENDING,
		batchSize,
	);
	for (const msg of pending.sort(
