 ...
 */
export declare function createChildSpan(
 ...
 */
export declare function setSampling(
	context: TraceContext,
	sampled: boolean,
): TraceContext;
/**
 ...
 */
export declare function getTraceState(
	context: TraceContext,
	vendor: string,
): string | null;
/**
 ...
 */
export declare function addBaggage(
	context: TraceContext,
	key: string,
	value: string,
): TraceContext;
 ...
 */
export declare function getBaggage(
	context: TraceContext,
	key: string,
): string | null;
