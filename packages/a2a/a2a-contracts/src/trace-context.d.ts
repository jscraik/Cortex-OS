 ...
 */
export declare function injectTraceContext(envelope: Record<string, unknown>, context: TraceContext): void;
/**
 * Propagate trace context from incoming to outgoing envelope
 * Creates a child span for the outgoing message
 */
export declare function propagateTraceContext(incomingEnvelope: {
    traceparent?: string;
    tracestate?: string;
    baggage?: string;
}, outgoingEnvelope: Record<string, unknown>): void;
/**
 ...
 */
export declare function addTraceState(context: TraceContext, vendor: string, value: string): TraceContext;
/**
