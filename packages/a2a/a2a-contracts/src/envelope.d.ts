import { type EvidenceArray } from '@cortex-os/contracts/dist/src/index.js';
import { z } from 'zod';
export declare const Envelope: z.ZodEffects<z.ZodObject<{
    id: z.ZodString;
    type: z.ZodString;
 ...
 */
export declare function withEvidence<T extends z.infer<typeof Envelope>>(envelope: T, evidence: EvidenceArray): T & {
