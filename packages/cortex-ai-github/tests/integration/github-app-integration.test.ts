    ...
    it('properly builds GitHub context from webhook payload', () => {
      const payload: GitHubWebhookPayload = {
        ...
        pull_request: {
          ...
          user: { login: 'author', id: 33333, type: 'User', html_url: 'https://github.com/author', avatar_url: 'https://github.com/avatar' }
        },
        sender: { login: 'author', id: 33333, type: 'User', html_url: 'https://github.com/author', avatar_url: 'https://github.com/avatar' }
      };
