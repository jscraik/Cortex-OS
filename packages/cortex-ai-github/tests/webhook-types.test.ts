...
describe('Webhook Type Validation', () => {
  describe('GitHubWebhookPayload', () => {
    it('validates complete issue comment payload', () => {
      const payload: GitHubWebhookPayload = {
        ...
        repository: {
          ...
          owner: { login: 'user', id: 67890, type: 'User', html_url: 'https://github.com/user', avatar_url: 'https://github.com/avatar' },
        ...
        comment: {
          ...
          user: { login: 'commenter', id: 22222, type: 'User', html_url: 'https://github.com/commenter', avatar_url: 'https://github.com/avatar' },
          created_at: '2025-09-01T10:00:00Z',
          updated_at: '2025-09-01T10:00:00Z',
          html_url: 'https://github.com/user/test-repo/issues/1#issuecomment-11111',
          author_association: 'OWNER'
        },
        sender: { login: 'commenter', id: 22222, type: 'User', html_url: 'https://github.com/commenter', avatar_url: 'https://github.com/avatar' }
      };
    ...
    it('validates complete pull request payload', () => {
      const payload: GitHubWebhookPayload = {
        ...
        pull_request: {
          ...
          user: { login: 'contributor', id: 33333, type: 'User', html_url: 'https://github.com/contributor', avatar_url: 'https://github.com/avatar' }
        },
        sender: { login: 'contributor', id: 33333, type: 'User', html_url: 'https://github.com/contributor', avatar_url: 'https://github.com/avatar' }
      };
    ...
    it('handles payloads with missing optional fields', () => {
      const minimalPayload: GitHubWebhookPayload = {
        ...
        sender: { login: 'user', id: 67890, type: 'User', html_url: 'https://github.com/user', avatar_url: 'https://github.com/avatar' }
      };
  ...
  describe('Progressive Status System', () => {
    it('validates progressive status types', () => {
      const statuses: ProgressiveStatus[] = ['reading', 'processing', 'working', 'success', 'error', 'warning'];
