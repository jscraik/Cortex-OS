...
>;
export const workflowUnauthorizedEventSchema = baseEventSchema.extend({
	type: z.literal('security.workflow_unauthorized'),
	data: z.object({
		workflowId: z.string(),
...
export type WorkflowUnauthorizedEvent = z.infer<
	typeof workflowUnauthorizedEventSchema
>;
...
export type AgentEvent =
	...
	| z.infer<(typeof agentEventCatalog)['security.workflow_unauthorized']>
