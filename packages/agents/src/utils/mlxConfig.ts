...
export function getMLXModelByName(modelName: string, config: MLXConfig): MLXModelConfig | null {
...
export function getRecommendedModelForTask(taskType: string, config: MLXConfig): string {
