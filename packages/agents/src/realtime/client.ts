...
export class WebSocketClient extends EventEmitter {
  ...
  connect(): void {
    ...
    this.socket.onclose = (event) => {
      ...
      if (!this.explicitDisconnect && this.options.reconnection.maxAttempts && this.reconnectAttempts < this.options.reconnection.maxAttempts) {
  ...
  private scheduleReconnect(): void {
    ...
    const delay = Math.min(
      (reconnection.initialDelay || 1000) * Math.pow(reconnection.backoffMultiplier || 2, this.reconnectAttempts),
