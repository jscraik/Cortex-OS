...
`;
      ...
      await fs.writeFile(path.join(tempDir, 'invalid.subagent.yml'), invalidContent);
...
`;
      ...
      await fs.writeFile(path.join(tempDir, 'integration-test.subagent.yml'), yamlContent);
