...
describe('brAInwav Master Agent System', () => {
	...
	describe('Agent Coordination', () => {
		it('should route code analysis requests correctly', async () => {
			...
			const result = await masterAgent.coordinate('Please analyze this code for quality issues');
		...
		it('should route test generation requests correctly', async () => {
			...
			const result = await masterAgent.coordinate('Generate unit tests for the login function');
