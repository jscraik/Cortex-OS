...
describe('CodeIntelligenceAgent', () => {
  ...
  describe('Model Integration', () => {
    ...
    it('should route to appropriate model based on urgency', async () => {
      mockFetch.mockResolvedValue(createMockResponse(mockModelResponses['deepseek-coder'] || mockOllamaResponse));
  ...
  describe('Complexity Assessment', () => {
    ...
    it('should assess complexity based on code structure', async () => {
      ...
      const complexity = (agent as any).assessComplexity ? (agent as any).assessComplexity(mediumCode) : 'low';
    ...
    it('should handle complex code structures', async () => {
      const complexCode = TestDataGenerator.generateCodeSample('javascript', 'high');
      const complexity = (agent as any).assessComplexity ? (agent as any).assessComplexity(complexCode) : 'medium';
