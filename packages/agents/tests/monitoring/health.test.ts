...
describe('HealthMonitor', () => {
  ...
  describe('Health Checks', () => {
    ...
    it('should collect Prometheus metrics', async () => {
      ...
      expect(prometheusMetrics).toContain('# HELP cortex_requests_success_total Total number of successful requests');
      expect(prometheusMetrics).toContain('cortex_requests_success_total 1');

      expect(prometheusMetrics).toContain('# HELP cortex_requests_error_total Total number of failed requests');
      expect(prometheusMetrics).toContain('cortex_requests_error_total 1');

      expect(prometheusMetrics).toContain('# HELP cortex_request_duration_seconds Request duration in seconds');
      expect(prometheusMetrics).toContain('# TYPE cortex_request_duration_seconds histogram');

      expect(prometheusMetrics).toContain('# HELP cortex_active_agents Current number of active agents');
      ...
      expect(prometheusMetrics).toContain('# HELP cortex_memory_usage_percent Memory usage percentage');
