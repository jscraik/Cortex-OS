  ...
  it('validates all known event schemas with sample payloads', () => {
    const samples: Record<string, any> = {
      ...
      'provider.success': {
        ...
        data: { providerId: 'p', modelId: 'm', latencyMs: 1, tokensUsed: 2, timestamp: iso() },
      },
      'provider.fallback': {
        type: 'provider.fallback',
        data: { fromProvider: 'p1', toProvider: 'p2', reason: 'timeout', timestamp: iso() },
      },
      ...
      'security.dependabot_config_loaded': {
        ...
        data: {
          ...
          projects: [
            ...
            { packageEcosystem: 'github-actions', directory: '/', scheduleInterval: 'weekly' },
          ],
          timestamp: iso(),
        },
      },
