...
describe('AgentStateStore', () => {
  ...
  describe('findBySessionId', () => {
    it('should find all agent states for a session', async () => {
      ...
      const state2 = await agentStateStore.create({ ...mockAgentState, sessionId, agentId: 'agent-456' });
  ...
  describe('findByAgentId', () => {
    it('should find agent states by agent ID', async () => {
      ...
      const state1 = await agentStateStore.create({ ...mockAgentState, agentId });
      const state2 = await agentStateStore.create({ ...mockAgentState, agentId, sessionId: 'session-789' });
