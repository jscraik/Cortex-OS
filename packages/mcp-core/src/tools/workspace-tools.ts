...
export class WorkspaceListTool implements McpTool<WorkspaceListInput, WorkspaceListResult> {
        ...
        async execute(
                ...
                try {
                        ...
                        mapWorkspaceManagerError(
                                error,
                                'brAInwav Workspace List failed',
                                'E_WORKSPACE_LIST_FAILED',
                        );
                }
        }
}
...
export class WorkspaceReadTool implements McpTool<WorkspaceReadInput, WorkspaceReadResult> {
        ...
        async execute(
                ...
                try {
                        ...
                        mapWorkspaceManagerError(
                                error,
                                'brAInwav Workspace Read failed',
                                'E_WORKSPACE_READ_FAILED',
                        );
                }
        }
}
...
function mapWorkspaceManagerError(error: unknown, fallbackMessage: string, fallbackCode: string): never {
