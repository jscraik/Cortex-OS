...
export class CreateCoordinationSessionTool implements McpTool<CreateCoordinationSessionInput, CoordinationSessionResult> {
        ...
        constructor(private readonly manager: CoordinationSessionManager = sharedCoordinationSessionManager) {}
