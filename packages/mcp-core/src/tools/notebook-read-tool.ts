...
export class NotebookReadTool implements McpTool<NotebookReadInput, NotebookReadResult> {
    ...
    async execute(input: NotebookReadInput, context?: ToolExecutionContext): Promise<NotebookReadResult> {
        ...
        try {
            ...
            try {
                ...
                throw new ToolExecutionError(`Invalid JSON in notebook: ${input.path}`, { code: 'E_INVALID_JSON', cause: e });
            }
