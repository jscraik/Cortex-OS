...
describe("ModelRouter", () => {
    ...
    describe("embedding generation", () => {
        ...
        it("should throw error when all local models fail", async () => {
            ...
            await expect(modelRouter.generateEmbedding({ text: "test text" })).rejects.toThrow("All embedding models failed");
        });
    ...
    describe("error handling", () => {
        it("should throw appropriate error when no models available", async () => {
            ...
            mockOllamaAdapter.listModels.mockResolvedValue([]);
            await modelRouter.initialize();
            await expect(modelRouter.generateEmbedding({ text: "test" })).rejects.toThrow("No embedding models available");
        });
        it("should provide detailed error information", async () => {
            ...
            await expect(modelRouter.generateEmbedding({ text: "test" })).rejects.toThrow("All embedding models failed");
        });
    });
    describe("reranking", () => {
        beforeEach(async () => {
