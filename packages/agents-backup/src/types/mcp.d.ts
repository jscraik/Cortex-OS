...
export interface MCPToolResponse<T = unknown> {
	content?: Array<{ type: string; text?: string; data?: T }>;
	isError?: boolean;
...
export interface MCPClientEvents {
	...
	knowledge_searched: { query: string; resultCount: number };
	task_created: TaskCreationResult;
	task_updated: { taskId: string; status: string; notes?: string };
	document_uploaded: { documentId: string; url: string };
}
