...
use cortex_core::protocol::AgentMessageDeltaEvent;
use cortex_core::protocol::AgentMessageEvent;
use cortex_core::protocol::AgentReasoningDeltaEvent;
use cortex_core::protocol::AgentReasoningEvent;
use cortex_core::protocol::AgentReasoningRawContentDeltaEvent;
use cortex_core::protocol::AgentReasoningRawContentEvent;
use cortex_core::protocol::ApplyPatchApprovalRequestEvent;
use cortex_core::protocol::BackgroundEventEvent;
use cortex_core::protocol::ErrorEvent;
use cortex_core::protocol::Event;
use cortex_core::protocol::EventMsg;
use cortex_core::protocol::ExecApprovalRequestEvent;
use cortex_core::protocol::ExecCommandBeginEvent;
use cortex_core::protocol::ExecCommandEndEvent;
use cortex_core::protocol::InputItem;
use cortex_core::protocol::ListCustomPromptsResponseEvent;
use cortex_core::protocol::McpListToolsResponseEvent;
use cortex_core::protocol::McpToolCallBeginEvent;
use cortex_core::protocol::McpToolCallEndEvent;
use cortex_core::protocol::Op;
use cortex_core::protocol::PatchApplyBeginEvent;
use cortex_core::protocol::StreamErrorEvent;
use cortex_core::protocol::TaskCompleteEvent;
use cortex_core::protocol::TokenUsage;
use cortex_core::protocol::TurnAbortReason;
use cortex_core::protocol::TurnDiffEvent;
use cortex_core::protocol::WebSearchBeginEvent;
use cortex_core::protocol::WebSearchEndEvent;
use cortex_protocol::parse_command::ParsedCommand;
...
use cortex_common::approval_presets::ApprovalPreset;
use cortex_common::approval_presets::builtin_approval_presets;
use cortex_common::model_presets::ModelPreset;
use cortex_common::model_presets::builtin_model_presets;
use cortex_core::ConversationManager;
use cortex_core::protocol::AskForApproval;
use cortex_core::protocol::SandboxPolicy;
use cortex_core::protocol_config_types::ReasoningEffort as ReasoningEffortConfig;
use cortex_file_search::FileMatch;
use uuid::Uuid;
...
pub(crate) struct ChatWidget {
    ...
    cortex_op_tx: UnboundedSender<Op>,
...
impl ChatWidget {
    ...
    fn on_session_configured(&mut self, event: cortex_core::protocol::SessionConfiguredEvent) {
        self.bottom_pane
        ...
        // Ask cortex-core to enumerate custom prompts for this session.
    ...
    fn on_plan_update(&mut self, update: cortex_core::plan_tool::UpdatePlanArgs) {
    ...
    fn on_exec_command_output_delta(
        &mut self,
        _ev: cortex_core::protocol::ExecCommandOutputDeltaEvent,
    ) {
    ...
    fn on_patch_apply_end(&mut self, event: cortex_core::protocol::PatchApplyEndEvent) {
        let ev2 = event.clone();
        self.defer_or_handle(
    ...
    fn on_get_history_entry_response(
        &mut self,
        event: cortex_core::protocol::GetHistoryEntryResponseEvent,
    ) {
        let cortex_core::protocol::GetHistoryEntryResponseEvent {
            offset,
            log_id,
            entry,
        } = event;
    ...
    pub(crate) fn handle_patch_apply_end_now(
        &mut self,
        event: cortex_core::protocol::PatchApplyEndEvent,
    ) {
    ...
    pub(crate) fn new(
        ...
        let cortex_op_tx = spawn_agent(config.clone(), app_event_tx.clone(), conversation_manager);
    ...
    pub(crate) fn new_from_existing(
        config: Config,
        conversation: std::sync::Arc<cortex_core::CortexConversation>,
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Compact => {
                ...
                self.app_event_tx.send(AppEvent::CortexOp(Op::Compact));
            }
            SlashCommand::Model => {
            ...
            SlashCommand::Logout => {
                if let Err(e) = cortex_core::auth::logout(&self.config.cortex_home) {
            ...
            SlashCommand::TestApproval => {
                ...
                self.app_event_tx.send(AppEvent::CortexEvent(Event {
                    id: "1".to_string(),
    ...
    pub(crate) fn handle_cortex_event(&mut self, event: Event) {
        ...
        match msg {
            ...
            _ => {
                tracing::trace!("handle_cortex_event: {:?}", msg);
            }
        }
    ...
    pub(crate) fn open_model_popup(&mut self) {
        ...
        for preset in presets.iter() {
            ...
            let actions: Vec<SelectionAction> = vec![Box::new(move |tx| {
                tx.send(AppEvent::CortexOp(Op::OverrideTurnContext {
                    cwd: None,
        ...
        self.bottom_pane.show_selection_view(
            ...
            Some("Switch between OpenAI models for this and future Cortex CLI session".to_string()),
    ...
    /// Forward an `Op` directly to cortex.
    pub(crate) fn submit_op(&self, op: Op) {
        // Record outbound operation for session replay fidelity.
        crate::session_log::log_outbound_op(&op);
        if let Err(e) = self.cortex_op_tx.send(op) {
