...
impl App {
    ...
    async fn handle_event(&mut self, tui: &mut tui::Tui, event: AppEvent) -> Result<bool> {
        match event {
            ...
            AppEvent::CortexEvent(event) => {
                self.chat_widget.handle_cortex_event(event);
            }
            ...
            AppEvent::CortexOp(op) => self.chat_widget.submit_op(op),
    ...
    pub(crate) fn token_usage(&self) -> cortex_core::protocol::TokenUsage {
