...
impl OutgoingMessageSender {
    ...
    pub(crate) async fn send_server_notification(&self, notification: ServerNotification) {
        let method = format!("cortex/event/{notification}");
...
// Additional mcp-specific data to be added to a [`cortex_core::protocol::Event`] as notification.params._meta
