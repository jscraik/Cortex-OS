...
"#;
        ...
        // Some versions of tui_markdown include a trailing space after the
        // list marker on the marker-only line (e.g. "1. "). Accept that
        // by expecting the space to keep the assertion stable across
        // renderer versions.
