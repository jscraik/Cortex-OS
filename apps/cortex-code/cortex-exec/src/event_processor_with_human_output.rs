use cortex_common::elapsed::format_duration;
use cortex_common::elapsed::format_elapsed;
...
use cortex_core::protocol::McpInvocation;
...
use cortex_core::protocol::SessionConfiguredEvent;
...
use crate::event_processor::CortexStatus;
use crate::event_processor::EventProcessor;
use crate::event_processor::handle_last_message;
use cortex_common::create_config_summary_entries;
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(&mut self, config: &Config, prompt: &str) {
        ...
        ts_println!(
            self,
            "OpenAI Cortex v{} (research preview)\n--------",
            VERSION
        );
    ...
    fn process_event(&mut self, event: Event) -> CortexStatus {
        ...
        match msg {
            ...
            EventMsg::TaskComplete(TaskCompleteEvent { last_agent_message }) => {
                ...
                return CortexStatus::InitiateShutdown;
            }
            ...
            EventMsg::AgentMessageDelta(AgentMessageDeltaEvent { delta }) => {
                if !self.answer_started {
                    ts_println!(self, "{}\n", "cortex".style(self.italic).style(self.magenta));
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_println!(
                    self,
                    "{} {}",
                    "cortex session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return CortexStatus::Shutdown,
