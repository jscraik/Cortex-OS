...
export const apiGatewayContract: ToolContracts = {
  name: 'api-gateway',
  description: 'Executes API operations exposed by the Cortex-OS REST interface with validation, caching, and auditing.',
  inputExample: {
...
export const responseHandlingContract: ToolContracts = {
  ...
  description: 'Normalizes raw API responses into structured MCP payloads with standardized metadata.',
  inputExample: {
    routeId: 'users.list',
    statusCode: 200,
    rawBody: { users: [] },
