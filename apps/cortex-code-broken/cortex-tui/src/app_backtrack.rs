...
use cortex_core::protocol::ConversationHistoryResponseEvent;
...
impl App {
    ...
    pub(crate) fn request_backtrack(
        ...
        self.app_event_tx.send(crate::app_event::AppEvent::CortexOp(
            cortex_core::protocol::Op::GetHistory,
        ));
    }
    ...
    async fn perform_fork(
        &self,
        entries: Vec<cortex_protocol::models::ResponseItem>,
        drop_count: usize,
        cfg: cortex_core::config::Config,
    ) -> cortex_core::error::Result<cortex_core::NewConversation> {
        self.server
    ...
    fn install_forked_conversation(
        ...
        tui: &mut tui::Tui,
        cfg: cortex_core::config::Config,
        new_conv: cortex_core::NewConversation,
        drop_count: usize,
        prefill: &str,
    ) {
