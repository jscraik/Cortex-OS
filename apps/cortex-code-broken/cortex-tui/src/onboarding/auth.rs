...
use cortex_login::ServerOptions;
...
impl AuthModeWidget {
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "> ".into(),
                "Sign in with ChatGPT to use Cortex as part of your paid plan".bold(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Cortex".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                "\u{1b}]8;;https://github.com/openai/cortex\u{7}Cortex docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
            "  Cortex can make mistakes".into(),
    ...
    fn render_env_var_missing(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            "  To use Cortex with the OpenAI API, set OPENAI_API_KEY in your environment"
                .fg(Color::Cyan)
                .into(),
            "".into(),
    ...
    fn start_chatgpt_login(&mut self) {
        ...
        self.error = None;
        let opts = ServerOptions::new(self.cortex_home.clone(), CLIENT_ID.to_string());
