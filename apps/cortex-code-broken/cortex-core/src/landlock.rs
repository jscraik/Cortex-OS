    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("cortex-linux-sandbox");
    spawn_child_async(
        cortex_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `cortex-linux-sandbox`.
