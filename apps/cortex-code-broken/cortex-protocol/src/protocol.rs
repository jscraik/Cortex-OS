//! Defines the protocol for a Cortex session between a client and an agent.
//!
...
use crate::mcp_placeholders::{CallToolResult, McpTool};
...
pub enum Op {
    ...
    /// for a turn of a [`crate::cortex_conversation::CortexConversation`].
    UserTurn {
        /// User input items, see `InputItem`
        items: Vec<InputItem>,
    ...
    Compact,
    /// Request to shut down cortex instance.
    Shutdown,
}

/// Determines the conditions under which the user is consulted to approve
/// running the command proposed by Cortex.
    ...
    fn serialize_event() {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                session_id,
                model: "cortex-mini-latest".to_string(),
                history_log_id: 0,
        ...
        assert_eq!(
            serialized,
            r#"{"id":"1234","msg":{"type":"session_configured","session_id":"67e55044-10b1-426f-9247-bb680e5fe0c8","model":"cortex-mini-latest","history_log_id":0,"history_entry_count":0}}"#
        );
    }
}
