...
from .optimization_engine import OptimizationEngine, OptimizationContext, TaskType
from .model_registry import ModelRegistry
from .memory_monitor import MemoryMonitor
from .security_validator import SecurityValidator, SecurityContext
from .performance_tracker import PerformanceTracker, InferenceMetrics
...
class MLOptimizationBridgeServer:
    ...
    async def start(self):
        ...
        try:
            # Send startup event
            await self.send_event("bridge_started", {
    ...
    async def process_message(self, message: Dict[str, Any]):
        ...
        try:
            ...
            await self.send_error(request_id, f"Method failed: {str(e)}")
    ...
    async def select_optimal_model(self, 
                                 ...
                                 force_reevaluation: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "model_config": {
                    ...
                    "specialized_tasks": [task.name for task in selection.model_config.specialized_tasks],
                ...
                "switch_reason": selection.switch_reason.name if selection.switch_reason else None
            }
    ...
    async def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            aggregated_metrics = await self.performance_tracker.get_aggregated_metrics(60)
    ...
    async def force_model_switch(self, 
                                model_name: str,
                                reason: str = "user_request") -> Dict[str, Any]:
        """Force model switch."""
        
        try:
            success = await self.optimization_engine.force_model_switch(model_name, reason)
            
            if success:
                await self.send_event("model_switched", {
    ...
    async def cleanup(self):
        ...
        try:
            ...
            await self.send_event("bridge_shutdown", {
                "timestamp": datetime.now().isoformat()
            })
