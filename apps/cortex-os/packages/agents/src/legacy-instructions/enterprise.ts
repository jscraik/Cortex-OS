...
import type { ConfigManager } from "@cortex-os/core";
      ...
      switch (subcommand) {
        ...
        case "optimize": {
          try {
            ...
            error(
              `Failed to analyze cost optimization: ${(err as Error).message}`,
            );
          }
          break;
        }
      ...
      switch (subcommand) {
        ...
        case "compliance": {
          ...
          try {
            ...
            error(
              `Failed to run compliance assessment: ${(err as Error).message}`,
            );
          }
          break;
        }
