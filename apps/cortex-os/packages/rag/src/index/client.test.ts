...
describe("FaissClient", () => {
  ...
  describe("Content Hash Generation", () => {
    ...
    it("should generate different hashes for different documents", () => {
      ...
      const documents2: DocumentEmbedding[] = [
        { doc_id: "doc1", embedding: [0.1, 0.2, 0.4] },
      ];
  ...
  describe("Build Index", () => {
    it("should build index successfully", async () => {
      ...
      mockGrpcClient.BuildIndex.mockImplementation(
  ...
  describe("Search Index", () => {
    it("should search index successfully", async () => {
      ...
      mockGrpcClient.SearchIndex.mockImplementation(
        (request: any, callback: any) => {
          callback(null, mockResponse);
        },
      );
  ...
  describe("Build Status", () => {
    it("should get build status successfully", async () => {
      ...
      mockGrpcClient.GetBuildStatus.mockImplementation(
        (request: any, callback: any) => {
          callback(null, mockResponse);
        },
      );
...
describe("Performance and Load Tests", () => {
  ...
  it("should handle large document sets", () => {
    const largeDocumentSet: DocumentEmbedding[] = Array.from(
      { length: 10000 },
      (_, i) => ({
        doc_id: `doc_${i}`,
  ...
  it("should generate consistent hashes for large datasets", () => {
    ...
    const hash1 = FaissClient.generateContentHash(
      largeDocumentSet,
      "test-model",
    );
    const hash2 = FaissClient.generateContentHash(
      [...largeDocumentSet],
      "test-model",
    );
