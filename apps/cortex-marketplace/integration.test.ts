...
describe('MCP Marketplace Integration Tests', () => {
    ...
    servers: [
      {
        ...
        publisher: { name: 'TestPublisher', email: 'test@example.com', verified: true },
  ...
  describe('Full Workflow Integration', () => {
    ...
    it('should handle complex search scenarios', async () => {
      ...
      expect(categoryResult.data.every((s: any) => s.category === 'development')).toBe(true);
      ...
      expect(riskResult.data.every((s: any) => s.security.riskLevel === 'low')).toBe(true);
      ...
      expect(featuredResult.data.every((s: any) => s.featured === true)).toBe(true);
