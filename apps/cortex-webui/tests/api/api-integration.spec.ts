    ...
    test.beforeAll(async () => {
      ...
      const docResponse = await apiContext.post('/documents', {
        data: {
          ...
          content: 'brAInwav Cortex-OS is an Autonomous Software Behavior Reasoning (ASBR) runtime that enables sophisticated AI workflows through event-driven architecture and Model Context Protocol integration.',
