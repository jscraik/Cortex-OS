...
export class MockServices {
  ...
  private generateMockProcessedContent(fileType: string): string {
    const contentMap: Record<string, string> = {
      'application/pdf': 'Extracted text content from PDF document with brAInwav Cortex-OS documentation...',
      'text/markdown': '# brAInwav Cortex-OS\n\nComprehensive documentation for the Autonomous Software Behavior Reasoning runtime...',
      'image/jpeg': 'Image processed successfully. Extracted metadata: brAInwav product screenshot, dimensions: 1920x1080...',
      'audio/mpeg': 'Audio transcribed successfully. Content: Discussion about brAInwav Cortex-OS implementation and ASBR principles...',
      'text/plain': 'Plain text document processed. Content contains information about brAInwav engineering practices...'
    };

    return contentMap[fileType] || 'File processed successfully with brAInwav Cortex-OS document processing pipeline.';
  }
