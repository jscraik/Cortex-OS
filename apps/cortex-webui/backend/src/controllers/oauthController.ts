...
export class OAuthController {
	...
	static async handleCallback(req: Request, res: Response): Promise<void> {
		try {
			...
			const result = await OAuthService.handleCallback(providerId, code as string, state as string);
	...
	static async linkAccount(req: Request, res: Response): Promise<void> {
		try {
			...
			const result = await OAuthService.linkAccount(session.userId, providerId, code, state);
	 ...
	 */
	static async validateConfiguration(_req: Request, res: Response): Promise<void> {
		try {
