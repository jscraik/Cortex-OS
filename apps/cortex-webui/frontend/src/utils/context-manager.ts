...
export class ContextManager {
    ...
    private extractKeyTopics(messages: any[]): string[] {
        ...
        const commonWords = new Set([
            ...
            'my', 'your', 'his', 'its', 'our', 'their', 'in', 'of', 'for',
            'with', 'by', 'from', 'up', 'about', 'into', 'through', 'during',
            'before', 'after', 'above', 'below', 'between', 'among', 'an',
        ]);
    ...
    private generateSummary(
        ...
        const userQuestions = userMessages.slice(0, 3).map(m =>
    ...
    pruneContext(messages: any[], targetTokenCount?: number): any[] {
        ...
        let currentTokens = this.calculateTokenCount(messages);
