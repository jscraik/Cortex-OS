...
const OnBoarding: React.FC<OnBoardingProps> = ({ onComplete }) => {
	...
	const models = [
		...
		},
		{
			id: 'claude-2',
			name: 'Claude 2',
			description: 'Great for analysis and long documents',
		},
		{
			id: 'llama-2',
			name: 'Llama 2',
			description: 'Open source model, good for privacy',
		},
	];
					...
					<div>
						...
						<div className="mt-4 space-y-3">
							{models.map((model) => (
								<button
									key={model.id}
									className={`w-full text-left flex items-start p-3 border rounded-lg ${
					...
					<div className="text-center">
						<div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-100">
							<svg
								...
								aria-hidden="true"
							>
								<title>Completion checkmark icon</title>
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
									strokeWidth={2}
