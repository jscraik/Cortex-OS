...
const Knowledge = forwardRef(({ command, onSelect }: KnowledgeProps, ref) => {
  ...
  const mockKnowledge: KnowledgeItem[] = [
    ...
    { id: '2', name: 'API Reference', description: 'API reference guide', type: 'file' },
    { id: '3', name: 'User Guide', description: 'User guide for the application', type: 'file' },
    {
      id: '4',
              ...
              >
                <div>
                  <div className="font-medium text-black dark:text-gray-100 flex items-center gap-1">
                    ...
                    <div className="line-clamp-1">{decodeString(item?.name)}</div>
                  </div>
