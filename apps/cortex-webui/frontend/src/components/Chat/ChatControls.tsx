			...
			<div className="flex items-center space-x-2">
				...
				>
					<svg
						...
						viewBox="0 0 20 20"
						fill="currentColor"
						aria-label="Keyboard shortcuts icon"
					>
