...
const ToolsSettings: React.FC<ToolsSettingsProps> = ({ saveSettings }) => {
  ...
  return (
    <div id="tab-tools" className="flex flex-col h-full justify-between text-sm">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    {tool.id === 'web-search' && (
                      <div className="space-y-3">
                        ...
                        <div>
                          <label className="block text-xs font-medium mb-1">Results Limit</label>
                          <input
                            type="number"
                            min="1"
                            max="20"
                          ...
                          <div className="flex flex-wrap gap-2">
                            {['python', 'javascript', 'bash'].map((lang) => (
                              <label key={lang} className="flex items-center text-xs">
                                <input
                                  type="checkbox"
                                  checked={tool.config?.languages?.includes(lang) || false}
                                  onChange={(e) => {
                                    const languages = tool.config?.languages || [];
