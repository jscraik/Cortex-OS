...
const AudioSettings: React.FC<AudioSettingsProps> = ({ saveSettings }) => {
  ...
  return (
    <div id="tab-audio" className="flex flex-col h-full justify-between text-sm">
      <div className="overflow-y-scroll max-h-[28rem] lg:max-h-full space-y-6">
        <div>
          ...
          <div className="space-y-4">
            ...
            {ttsEnabled && (
              <>
                <div>
                  <label htmlFor="tts-engine" className="block text-sm font-medium mb-1">
                    TTS Engine
                  </label>
                  <select
                    id="tts-engine"
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            {sttEnabled && (
              <div>
                <label htmlFor="stt-engine" className="block text-sm font-medium mb-1">
                  STT Engine
                </label>
                <select
                  id="stt-engine"
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="audio-output" className="block text-sm font-medium mb-1">
                Audio Output Device
              </label>
              <select
                id="audio-output"
            ...
            <div>
              <label htmlFor="audio-input" className="block text-sm font-medium mb-1">
                Audio Input Device
              </label>
              <select
                id="audio-input"
            ...
            <div>
              <label htmlFor="audio-volume" className="block text-sm font-medium mb-1">
                Volume: {audioVolume}%
              </label>
              <input
                id="audio-volume"
