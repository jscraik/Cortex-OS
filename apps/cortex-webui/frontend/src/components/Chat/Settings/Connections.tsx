...
const ConnectionsSettings: React.FC<ConnectionsSettingsProps> = ({ saveSettings }) => {
  ...
  return (
    <div id="tab-connections" className="flex flex-col h-full justify-between text-sm">
      <div className="overflow-y-scroll max-h-[28rem] lg:max-h-full space-y-6">
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="google-api-key" className="block text-sm font-medium mb-1">
                Google API Key
              </label>
              <div className="flex space-x-2">
                <input
            ...
            <div>
              <label htmlFor="mistral-api-key" className="block text-sm font-medium mb-1">
                Mistral API Key
              </label>
              <div className="flex space-x-2">
                <input
            ...
            <div>
              <label htmlFor="groq-api-key" className="block text-sm font-medium mb-1">
                Groq API Key
              </label>
              <div className="flex space-x-2">
                <input
            ...
            <div>
              <label htmlFor="openrouter-api-key" className="block text-sm font-medium mb-1">
                OpenRouter API Key
              </label>
              <div className="flex space-x-2">
                <input
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="custom-openai-endpoint" className="block text-sm font-medium mb-1">
            ...
            <div>
              <label htmlFor="custom-openai-api-key" className="block text-sm font-medium mb-1">
