...
const ShortcutsModal: React.FC<ShortcutsModalProps> = ({ isOpen, onClose }) => {
  const shortcuts: Shortcut[] = [
    ...
    { key: 'Ctrl + Enter', description: 'Add new line (alternative)', category: 'Chat' },
    { key: 'Esc', description: 'Cancel editing', category: 'Chat' },
    { key: '↑ / ↓', description: 'Navigate chat history', category: 'Chat' },

    // Navigation shortcuts
    { key: 'Ctrl + Shift + K', description: 'Focus search', category: 'Navigation' },
    { key: 'Ctrl + N', description: 'New chat', category: 'Navigation' },
    { key: 'Ctrl + Shift + N', description: 'New folder', category: 'Navigation' },
    { key: 'Ctrl + O', description: 'Open chat', category: 'Navigation' },
    { key: 'Ctrl + Shift + O', description: 'Open settings', category: 'Navigation' },
    ...
    { key: 'Ctrl + Shift + K', description: 'Insert code', category: 'Editing' },

    // Application shortcuts
    { key: 'Ctrl + ,', description: 'Open settings', category: 'Application' },
    { key: 'Ctrl + Shift + D', description: 'Toggle dark mode', category: 'Application' },
    { key: 'Ctrl + Shift + F', description: 'Toggle fullscreen', category: 'Application' },
    { key: 'Ctrl + Shift + H', description: 'Show shortcuts', category: 'Application' },
    { key: 'Ctrl + Shift + P', description: 'Open command palette', category: 'Application' },

    // Model shortcuts
    { key: 'Ctrl + M', description: 'Switch model', category: 'Model' },
    { key: 'Ctrl + Shift + M', description: 'Open model selector', category: 'Model' },
  ];
