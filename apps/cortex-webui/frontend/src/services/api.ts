...
import { Conversation, Message, User, Model, FileUpload } from '../types';
...
export const messageAPI = {
  ...
  create: async (conversationId: string, content: string, role: 'user' | 'assistant' | 'system' = 'user'): Promise<Message> => {
    return apiCall(`/conversations/${conversationId}/messages`, {
      method: 'POST',
