...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
	...
	}, [auth.isAuthenticated, auth.user, loadOAuthAccounts]);
	...
	const unlinkOAuthAccount = async (providerId: string, providerAccountId: string) => {
		try {
	...
	const hasPermission = (permission: string) => authUtils.hasPermission(auth.user, permission);
