...
async function testRestAPI() {
    ...
    try {
        ...
        console.log(''); console.log('🚀 DUAL MODE CONFIRMED: Both MCP and REST API are working!');
...
function printCLIExamples() {
    ...
    console.log('  -d \'{"content":"TDD red phase: failing test written","tags":["tdd","red"],"importance":9}\'');
    console.log('');
    ...
    console.log('  -H "Content-Type: application/json" \\');
    console.log('  -d \'{"query":"orchestration architecture decisions","analysis_type":"patterns"}\'');
    console.log('');
}
